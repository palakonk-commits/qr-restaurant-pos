    ...
    <div className="text-gray-800 dark:text-gray-200">
      <div className="space-y-2">
        {order.items.map(item => (
          <div key={item.id} className="flex justify-between items-start py-2 border-b dark:border-gray-700">
            <div>
      ...
      <div className="mt-4 pt-4 border-t-2 border-dashed dark:border-gray-600 space-y-1 text-right">
